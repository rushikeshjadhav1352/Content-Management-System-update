...
<?php
	...
	if(isset($_GET['del'])) {
		if($_SESSION['role'] == 'Administrator' ||
			...
			$cid = mysqli_real_escape_string($connection, $_GET['del']);
		
			$query = "DELETE FROM cms_comments WHERE comment_id = $cid";
...
<?php
	if(isset($_GET['pid'])) {
		...
		$q = "slect cms_comments.*, cms_posts.post_id, cms_posts.post_title,
					...
					order by cms_comments.comment_date ";
